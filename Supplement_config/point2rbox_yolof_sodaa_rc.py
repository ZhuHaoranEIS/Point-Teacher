...
model = dict(
    ...
    sca_fact=0.4,
    sca_range=(0.5, 1.5),
    basic_pattern='data/basic_patterns/soda',
    dense_cls=[i for i in range(4)],
    use_setrc=True,
    use_setsk=False,
...
train_pipeline = [
    ...
    dict(type='mmdet.Resize', scale=(1200, 1200), keep_ratio=True),
    dict(type='RBox2Point'),
    dict(
        type='mmdet.RandomFlip',
        prob=0.0,
        direction=['horizontal', 'vertical', 'diagonal']),
    dict(type='mmdet.RandomShift', prob=0.0, max_shift_px=16),
