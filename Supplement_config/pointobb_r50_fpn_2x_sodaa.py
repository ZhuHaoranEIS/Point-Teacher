...
data = dict(
    ...
    train=dict(
        ...
        ann_file = "/data/zhr/SODA/SODA-A/divData/train/Annotations_pointobb/soda_0.0.json",
        img_prefix = '/data/zhr/SODA/SODA-A/divData/train/Images_filter/',
...
work_dir = '/home/zhr/pointobb/PointOBB/work_dir/soda_0.0_2stage/'
