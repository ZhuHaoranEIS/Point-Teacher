...
image_root = '/data/zhr/AI-TOD/AI-TOD-v1/'
data_root = '/data/zhr/AI-TOD/AI-TOD-v2/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/data/zhr/AI-TOD/AI-TOD-v2/p2bnet/aitodv2_point_center_w_gt_train.json",
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'aitodv2_val.json',
...
work_dir = '/home/zhr/P2BNet/results/center_one_stage/'
