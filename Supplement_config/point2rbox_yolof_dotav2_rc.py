_base_ = [
    '../_base_/datasets/dotav2_point_teacher.py', '../_base_/schedules/schedule_1x.py',
...
model = dict(
    ...
    sca_fact=0.4,
    sca_range=(0.5, 1.5),
    basic_pattern='data/basic_patterns/dotav2',
    dense_cls=[4, 5, 6, 9],
    use_setrc=True,
    use_setsk=False,
...
# val_evaluator = dict(type='RotatedCocoMetric')
