_base_ = [
    '/home/zhr/pointobb/PointOBB/configs/_base_/default_runtime.py'
]
...
train_pipeline = [
    ...
    dict(type='RandomFlip', flip_ratio=0.0,version=angle_version) if not debug else dict(type='RandomFlip', flip_ratio=0.),
...
data = dict(
    ...
    train=dict(
        ...
        ann_file = '/data/zhr/DOTAv2/obb/pointobb/json_files/train_rbox_pt_P2Bfmt.json',
...
work_dir = '/home/zhr/pointobb/PointOBB/work_dirs/dotav2_pointobb/'

evaluation = dict(
    interval=12*training_time, metric='bbox',
...
# Inference
load_from = '/home/zhr/pointobb/PointOBB/work_dirs/dotav2_pointobb/epoch_24.pth'

evaluation = dict(
    save_result_file='/data/zhr/DOTAv2/obb/pointobb/test_file/pseudo_obb_result.json',
    do_first_eval=True
)
