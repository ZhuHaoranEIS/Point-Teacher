...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/data/zhr/AI-TOD/aitodv2_plug/aitodv2_train_center_second.json',
...
work_dir = '/home/zhr/PLUG/PLUG-Det/results/aitodv2_center/'
