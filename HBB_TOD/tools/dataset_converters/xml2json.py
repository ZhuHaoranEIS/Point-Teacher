...
def parseXmlFilse(data_dir, json_save_path, split='train'):
    ...
    if os.path.isfile(image_sets_file):
        ...
        xml_files_list = [os.path.join(data_dir, "Annotations", "HBB", f"{i}.xml") for i in ids]
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--voc-dir', type=str, default='/data/xc/DIOR', help='voc path')
    parser.add_argument('-s', '--save-path', type=str, default='/data/zhr/DIOR/test.json', help='json save path')
    parser.add_argument('-t', '--type', type=str, default='test', help='only use in voc2012/2007')
    ...
    if len(sys.argv) > 1:
        ...
        voc_data_dir = '/data/xc/DIOR'
        json_save_path = '/data/zhr/DIOR/test.json'
        split = 'test'
