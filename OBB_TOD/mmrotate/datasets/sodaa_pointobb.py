...
class SODAAPOINTOBBDataset(CustomDataset):
    ...
    def __init__(self,
        ...
        super(SODAAPOINTOBBDataset, self).__init__(ann_file, pipeline, **kwargs)
    ...
    def load_annotations(self, ann_folder):
        """
            Args:
                ann_folder: folder that contains DOTA v15 annotations txt files
        """
        cls_map = {c: i
