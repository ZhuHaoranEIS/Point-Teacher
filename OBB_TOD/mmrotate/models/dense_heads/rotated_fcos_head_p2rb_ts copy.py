...
class TS_P2RBRotatedFCOSHead(RotatedAnchorFreeHead):
    ...
    def __init__(self,
                 ...
                 train_cfg=dict(
                     ...
                     fuse_assigner=dict(
                         ...
                         location_cost=dict(type='CenternessCost', mode='L1', weight=10.0),
    ...
    def get_pseudo_bbox(self,
        ...
        pseudo_bboxes, pos_gts, mean_ious_pred = results

        return pseudo_bboxes, pos_gts, mean_ious_pred
    ...
    def loss_pseudo(self,
        ...
        labels, bbox_targets, angle_targets = results
    ...
    def get_target_pseudo(self, points, gt_points_list, gt_labels_list, gt_bboxes_list, img_metas, gt_augument_ignore, 
        ...
        labels_list, bbox_targets_list, angle_targets_list = results
    ...
    def gnerate_pseudo(self, points, gt_points_list, gt_labels_list, gt_bboxes_list, img_metas,  
        ...
        return pseudo_bboxes, pos_gts, sum(mean_ious_pred)/len(mean_ious_pred)
    ...
    def _gnerate_pseudo_single(self, gt_points, gt_labels, gt_bboxes, cls_scores, bbox_preds, centernesses, 
        ...
        assign_result = self.fuse_assigner.assign(points, cls_scores.clone().detach(), centernesses,
