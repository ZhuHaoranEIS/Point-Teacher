...
from .rotated_rpn_head_psla import PSRotatedRPNHead
...
class PSOrientedRPNHead(PSRotatedRPNHead):
    ...
    def _get_targets_single(self,
        ...
        if self.use_prediction:
            ...
            bbox_preds = obb2xyxy(bbox_preds, self.version)
            assign_result = self.assigner.assign(bbox_preds, cls_scores, gt_hbboxes, gt_labels, gt_bboxes_ignore=None)
            # assign_result = self.assigner.assign(bbox_preds_refine, cls_scores, gt_bboxes, gt_labels, gt_bboxes_ignore=None)
        else:
        ...
        # image_store_path = "/home/zhuhaoran/SODA/mmrotate/models/dense_heads/assignment_vis_rpn/"
